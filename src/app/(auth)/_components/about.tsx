      ...
      <section id="about">
         <div className="container">
            ...
            <div className="about-left">
               ...
               <h1 data-aos="fade-down" className="section-title reveal-right">Sua jornada para o <span>sorriso perfeito</span> começa aqui</h1>
               ...
               <ul className="about-list">
                  ...
                  <li data-aos="fade-left" className="about-list-item D4">
                     <img src="./svgs/check-badge.svg" alt="" className="check" />
                     <p>Ambiente confortável</p>
                  </li>
                  <li data-aos="fade-right" className="about-list-item D4">
                     <img src="./svgs/check-badge.svg" alt="" className="check" />
